...
public class TestClorus {
    ...
    public void testReplicate() {
        ...
        Clorus babyClorus2 = c.replicate();
        assertEquals(0.5, c.energy(), 0.01);
        assertEquals(0.5, babyClorus2.energy(), 0.01);
    }
    ...
    public void testChoose() {
        ...
        surrounded2.put(Direction.TOP, new Plip(0.5));
        surrounded2.put(Direction.BOTTOM, new Plip(1));
        surrounded2.put(Direction.LEFT, new Plip(0.5));
